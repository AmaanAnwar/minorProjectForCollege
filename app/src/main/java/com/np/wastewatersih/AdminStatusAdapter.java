...
public class  AdminStatusAdapter extends RecyclerView.Adapter<AdminStatusAdapter.ImageViewHolder>  {
    ...
    public AdminStatusAdapter(Context context, List<AdminStatusClass> uploads)
    {
        mContext=context;
        mUploads=uploads;
    }
    ...
    public void onBindViewHolder(@NonNull ImageViewHolder imageViewHolder, int i) {
        final AdminStatusClass uploadCur = mUploads.get(i);
                ...
                if (isLongClick) {
                    ...
                    adb.setPositiveButton("Accept", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Intent intent = new Intent(mContext, AdminStatus.class);
